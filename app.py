...
st.markdown(
    ...
    [data-testid="stSegmentedControl"] :is(
    ...
    [data-testid="stSegmentedControl"] :is(button, [role="radio"]) :is(p, span),
    button[data-testid="stBaseButton-segmented_control"] :is(p, span),
    button[data-testid="stBaseButton-segmented_controlActive"] :is(p, span) {
        color: #1E293B !important;
    }
    [data-testid="stSegmentedControl"] :is([data-baseweb="button-group"] > button, [role="radio"]):hover,
